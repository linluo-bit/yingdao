...
class WebDriverManager:
    ...
    def create_driver(self, browser: str = "chrome", headless: bool = False, 
                     user_data_dir: Optional[str] = None, **kwargs) -> webdriver.Remote:
        """
        创建WebDriver实例
    ...
    def _create_chrome_driver(self, **kwargs) -> webdriver.Chrome:
        ...
        chrome_paths = [
            ...
            r"C:\Users\{}\AppData\Local\Google\Chrome\Application\chrome.exe".format(os.getenv('USERNAME', 'Default'))
        ]
        ...
        try:
            if chromedriver_path.exists():
                ...
                logger.warning(f"未找到本地ChromeDriver: {chromedriver_path}，尝试使用系统PATH")
